...
public class RegisterActivity extends AppCompatActivity {
    EditText editSignupName, editSignupSubscription, editSignupCodeVerification;
    ...
    private final String CODE_VERIFICATION = "pales@&";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editSignupCodeVerification = findViewById(R.id.edit_signup_codeVerification);
        ...
        btnSignupSign.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (editSignupName.getText().toString().trim().isEmpty() || editSignupPhone.getText().toString().trim().isEmpty() ||
                        editSignupSubscription.getText().toString().trim().isEmpty() || TextUtils.isEmpty(editSignupCodeVerification.getText().toString())) {
                    Toast.makeText(RegisterActivity.this, R.string.pleaseCompleteAllVales, Toast.LENGTH_SHORT).show();
                    return;
                }

                if (!editSignupCodeVerification.getText().toString().equals(CODE_VERIFICATION)){
                    Toast.makeText(RegisterActivity.this, R.string.verificationNotCorrect, Toast.LENGTH_SHORT).show();
                    return;
                }
