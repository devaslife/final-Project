...
import com.example.ucasproject.AllScreen;
        ...
        btnLoginlogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (textId.getText().toString() != null) {
                    ...
                    PhoneAuthCredential phoneAuthCredential = PhoneAuthProvider.getCredential(code, code);

                    FirebaseAuth.getInstance().signInWithCredential(phoneAuthCredential).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        @Override
                        public void onComplete(@NonNull Task<AuthResult> task) {
                                Intent intent = new Intent(LoginActivity.this, AllScreen.class);
